    ...
    fun setNameAndModel(name: String) {
        ...
        model =
                when {
                    ...
                    shortName == "ECB-10" || shortName == "ECB-20" || shortName == "ECB-30" ->
                            WatchModel.ECB
        ...
        modelMap[model]?.let { modelInfo ->
            with(modelInfo) {
                ...
                this@WatchInfo.hasMultipleFonts = hasMultipleFonts
            }
        }
                ?: modelMap[WatchModel.GENERIC]?.let { defaultModel ->
                    with(defaultModel) {
                        this@WatchInfo.hasReminders = hasReminders
                        this@WatchInfo.hasAutoLight = hasAutoLight
                        this@WatchInfo.alarmCount = alarmCount
