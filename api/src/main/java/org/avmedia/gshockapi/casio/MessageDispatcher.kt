...
import org.avmedia.gshockapi.io.HealthDataIO
...
object MessageDispatcher {
    ...
    @RequiresApi(Build.VERSION_CODES.O)
    private val dataReceivedMessages =
            mapOf<Int, (String) -> Unit>(
                    CasioConstants.CHARACTERISTICS.CASIO_SETTING_FOR_ALM.code to
                            AlarmsIO::onReceived,
                    CasioConstants.CHARACTERISTICS.CASIO_SETTING_FOR_ALM2.code to
                            AlarmsIO::onReceived,
                    CasioConstants.CHARACTERISTICS.CASIO_DST_SETTING.code to
                            DstForWorldCitiesIO::onReceived,
                    CasioConstants.CHARACTERISTICS.CASIO_REMINDER_TIME.code to EventsIO::onReceived,
                    CasioConstants.CHARACTERISTICS.CASIO_REMINDER_TITLE.code to
                            EventsIO::onReceivedTitle,
                    CasioConstants.CHARACTERISTICS.CASIO_TIMER.code to TimerIO::onReceived,
                    CasioConstants.CHARACTERISTICS.CASIO_HEALTH_DATA.code to
                            HealthDataIO::onReceived,
                    CasioConstants.CHARACTERISTICS.CASIO_WORLD_CITIES.code to
                            WorldCitiesIO::onReceived,
                    CasioConstants.CHARACTERISTICS.CASIO_DST_WATCH_STATE.code to
                            DstWatchStateIO::onReceived,
                    CasioConstants.CHARACTERISTICS.CASIO_WATCH_NAME.code to WatchNameIO::onReceived,
                    CasioConstants.CHARACTERISTICS.CASIO_WATCH_CONDITION.code to
                            WatchConditionIO::onReceived,
                    CasioConstants.CHARACTERISTICS.CASIO_APP_INFORMATION.code to
                            AppInfoIO::onReceived,
                    CasioConstants.CHARACTERISTICS.CASIO_BLE_FEATURES.code to
                            ButtonPressedIO::onReceived,
                    CasioConstants.CHARACTERISTICS.CASIO_SETTING_FOR_BASIC.code to
                            SettingsIO::onReceived,
                    CasioConstants.CHARACTERISTICS.CASIO_SETTING_FOR_BLE.code to
                            TimeAdjustmentIO::onReceived,
                    CasioConstants.CHARACTERISTICS.ERROR.code to ErrorIO::onReceived,
                    CasioConstants.CHARACTERISTICS.FIND_PHONE.code to
                            RunActionsIO::onReceived, // always-connected watches, use PHONE FINDER
                    // to invoke actions...
