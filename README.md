...
When setting time, this app will also set the Home Time, Timezone and DST to your current location. 
So when travelling to another timezone, set time and you are good to go.
