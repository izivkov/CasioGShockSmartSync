...
This app integrates the Casio G-shock square digital Bluetooth watches ([B5600](https://amzn.to/3LDv7zT), [B5000](https://amzn.to/3n5L0Fd) series), with Google services such as `Google Calendar` events and
